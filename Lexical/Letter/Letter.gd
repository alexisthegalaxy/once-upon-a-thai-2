...
func dialog_ended():
#	print("starts test!")
#	Game.start_test("res://Test/Letter/TestPronFromThaiLet.tscn", id, self)  # first test
	Game.start_test("res://Test/Letter/TestWordFromSound.tscn", id, self)  # final test - just for debugging
#	wobbles = false
